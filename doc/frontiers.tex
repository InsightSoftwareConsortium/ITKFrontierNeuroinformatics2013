...
capabilities of the toolkit. An automated quantification of a brain tumor's
volume change is demonstrated on model datasets that are publically available
under a Creative-Commons Attribution (CC-BY) license
\cite{Prastawa2009,Niethammer2011}.
